...
class ChatService(object):
    ...
    def GetLeaderInfo(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ChatService/GetLeaderInfo',
    ...
    def SaveGameState(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ChatService/SaveGameState',
    ...
    def CheckVersion(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ChatService/CheckVersion',
...
class ReplicationService(object):
    ...
    def ReplicateSaveGameState(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ReplicationService/ReplicateSaveGameState',
